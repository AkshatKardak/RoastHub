...
Generate exactly 10 tweets about "${topic}". Return ONLY the JSON object, no other text.`;
    ...
    if (error.status === 429 || error.message.includes('quota') || error.message.includes('429')) {
      ...
      console.error('   2. Verify your GROQ_API_KEY in .env file');
      console.error('   3. Wait for quota reset or upgrade your plan');
    } else if (error.status === 401 || error.message.includes('401')) {
      console.error('⚠️ Invalid Groq API key. Please check your GROQ_API_KEY in .env file');
    } else {
  ...
  const templates = [
    {
      ...
      viral: 9, relatable: 8, savage: 7, brutal: 8,
    ...
    },
    {
      ...
      viral: 8, relatable: 9, savage: 8, brutal: 7,
    ...
    },
    {
      ...
      viral: 7, relatable: 9, savage: 8, brutal: 8,
    ...
    },
    {
      ...
      viral: 8, relatable: 8, savage: 8, brutal: 7,
    ...
    },
    {
      ...
      viral: 9, relatable: 7, savage: 9, brutal: 8,
    ...
    },
    {
      ...
      viral: 8, relatable: 9, savage: 7, brutal: 6,
    ...
    },
    {
      ...
      viral: 9, relatable: 8, savage: 6, brutal: 5,
    ...
    },
    {
      ...
      viral: 9, relatable: 8, savage: 8, brutal: 7,
